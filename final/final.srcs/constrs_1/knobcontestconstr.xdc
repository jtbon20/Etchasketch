...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports UP]					
	set_property IOSTANDARD LVCMOS33 [get_ports UP]
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports DOWN]					
	set_property IOSTANDARD LVCMOS33 [get_ports DOWN]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports LEFT]					
#	set_property IOSTANDARD LVCMOS33 [get_ports LEFT]
##Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports RIGHT]					
#	set_property IOSTANDARD LVCMOS33 [get_ports RIGHT]
##Sch name = JB7
...
##Sch name = JC4
#set_property PACKAGE_PIN P18 [get_ports press1]					
#	set_property IOSTANDARD LVCMOS33 [get_ports press1]
##Sch name = JC7
